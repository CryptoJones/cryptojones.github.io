...
![GIGABYTE RTX 3060 EAGLE OC 12 GB specifications]({{ site.baseurl }}/images/rtx3060-eagle-oc.png)

*Specs via [TechPowerUp's GPU database](https://www.techpowerup.com/gpu-specs/gigabyte-rtx-3060-eagle-oc.b8629).*
...
- **All in [vLLM](https://github.com/vllm-project/vllm)** — batched, production-grade serving on a single card.
...
Interested? **[Reply to the original post on Mastodon](https://infosec.exchange/@CryptoJones/116699970101195679)** and we'll sort out the details.
